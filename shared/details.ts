// Single source of truth for the project cards shown on BOTH the cursed site
// (apps/cursed) and the portfolio (apps/portfolio). Edit here once.
// Imported via the "@shared/*" path alias configured in each app's tsconfig.
